...
plt.plot(wavelengths, flux_post_atmosphere_1_lower, color='#AA4655', linewidth=3, linestyle="dotted")
plt.plot(wavelengths, flux_post_atmosphere_1_average, color='#AA4655', linewidth=5)
plt.plot(wavelengths, flux_post_atmosphere_1_average, color='#AA4655', linewidth=10, alpha=0.5)
plt.plot(wavelengths, flux_post_atmosphere_1_upper, color='#AA4655', linewidth=3, linestyle='dashed')
plt.plot(wavelengths, flux_post_atmosphere_2_lower, color='#AC982E', linewidth=3, linestyle="dotted")
plt.plot(wavelengths, flux_post_atmosphere_2_average, color='#AC982E', linewidth=5)
plt.plot(wavelengths, flux_post_atmosphere_2_average, color='#AC982E', linewidth=10, alpha=0.5)
plt.plot(wavelengths, flux_post_atmosphere_2_upper, color='#AC982E', linewidth=3, linestyle='dashed')
plt.plot(wavelengths, flux_post_atmosphere_3_lower, color='#329BDB', linewidth=3, linestyle="dotted")
plt.plot(wavelengths, flux_post_atmosphere_3_average, color='#329BDB', linewidth=5)
plt.plot(wavelengths, flux_post_atmosphere_3_average, color='#329BDB', linewidth=10, alpha=0.5)
plt.plot(wavelengths, flux_post_atmosphere_3_upper, color='#329BDB', linewidth=3, linestyle='dashed')
plt.xlabel('Wavelength, nm', fontsize=45)
plt.ylabel(f'Irradiance, {unicodeit.replace("W m^{-2} nm^{-1}")}', fontsize=40)
plt.yscale('log')
...
plt.text(single_PO_bond_wavelength, 10 ** (0), "P-O", rotation=90, verticalalignment='center',
         horizontalalignment='left', color='black', fontsize=35)

plt.axvline(x=single_CH_bond_wavelength, color='black', linewidth=1.5)
plt.text(single_CH_bond_wavelength, 10 ** (0), "C-H", rotation=90, verticalalignment='center',
         horizontalalignment='left', color='black', fontsize=35)
...
plt.text(single_CO_bond_wavelength, 10 ** (-4.5), "C-P", rotation=90, verticalalignment='center',
         horizontalalignment='right', color='black', fontsize=35)
...
plt.axvspan(only_uvc[0], only_uvc[1], label=f"UVC (100nm-280nm)", color='#7F66FF', alpha=0.25)
plt.axvspan(only_uvb[0], only_uvb[1], label=f"UVB (280nm-315nm)", color='#E3006A', alpha=0.25)
plt.axvspan(only_uva[0], only_uva[1], label=f"UVA (315nm-400nm)", color='#FF6600', alpha=0.25)

plt.tight_layout()
timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
file_path_save = os.path.join(directory, f"Irradiance_vs_Wavelength_Earth_Surface_{timestamp}.pdf")
