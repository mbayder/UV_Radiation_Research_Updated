...
plt.plot(wavelengths, flux_post_atmosphere_1_lower, color='#D55E00', linewidth=1, linestyle="dotted")
plt.plot(wavelengths, flux_post_atmosphere_1_average, color='#D55E00', linewidth=1)
plt.plot(wavelengths, flux_post_atmosphere_1_average, color='#D55E00', linewidth=8, alpha=0.5)
plt.plot(wavelengths, flux_post_atmosphere_1_upper, color='#D55E00', linewidth=1, linestyle='dashed')
plt.plot(wavelengths, flux_post_atmosphere_2_lower, color='#009E73', linewidth=1, linestyle="dotted")
plt.plot(wavelengths, flux_post_atmosphere_2_average, color='#009E73', linewidth=1)
plt.plot(wavelengths, flux_post_atmosphere_2_average, color='#009E73', linewidth=8, alpha=0.5)
plt.plot(wavelengths, flux_post_atmosphere_2_upper, color='#009E73', linewidth=1, linestyle='dashed')
plt.plot(wavelengths, flux_post_atmosphere_3_lower, color='#7E2954', linewidth=1, linestyle="dotted")
plt.plot(wavelengths, flux_post_atmosphere_3_average, color='#7E2954', linewidth=1)
plt.plot(wavelengths, flux_post_atmosphere_3_average, color='#7E2954', linewidth=8, alpha=0.5)
plt.plot(wavelengths, flux_post_atmosphere_3_upper, color='#7E2954', linewidth=1, linestyle='dashed')
...
file_path_save = os.path.join(directory, f"Irradiance_vs_Wavelength_Earth_Surface_{timestamp}.png")
