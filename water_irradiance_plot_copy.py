...
plt.plot(wavelengths, flux_post_water_mixed_1_lower, color='#AA4655', linewidth=3, linestyle="dotted")
plt.plot(wavelengths, flux_post_water_mixed_1_average, color='#AA4655', linewidth=5)
plt.plot(wavelengths, flux_post_water_mixed_1_average, color='#AA4655', linewidth=10, alpha=0.5)
plt.plot(wavelengths, flux_post_water_mixed_1_upper, color='#AA4655', linewidth=3, linestyle='dashed')
plt.plot(wavelengths, flux_post_water_mixed_2_lower, color='#AC982E', linewidth=3, linestyle="dotted")
plt.plot(wavelengths, flux_post_water_mixed_2_average, color='#AC982E', linewidth=5)
plt.plot(wavelengths, flux_post_water_mixed_2_average, color='#AC982E', linewidth=10, alpha=0.5)
plt.plot(wavelengths, flux_post_water_mixed_2_upper, color='#AC982E', linewidth=3, linestyle='dashed')
plt.plot(wavelengths, flux_post_water_mixed_3_lower, color='#329BDB', linewidth=3, linestyle="dotted")
plt.plot(wavelengths, flux_post_water_mixed_3_average, color='#329BDB', linewidth=5)
plt.plot(wavelengths, flux_post_water_mixed_3_average, color='#329BDB', linewidth=10, alpha=0.5)
plt.plot(wavelengths, flux_post_water_mixed_3_upper, color='#329BDB', linewidth=3, linestyle='dashed')
plt.xlabel('Wavelength, nm', fontsize=35)
plt.ylabel(f'Irradiance, {unicodeit.replace("W m^{-2} nm^{-1}")}', fontsize=35)
plt.yscale('log')
...
plt.text(single_CC_bond_wavelength, 10 ** (-3.5), "C-C", rotation=90, verticalalignment='center',
         horizontalalignment='left', color='black', fontsize=30)

plt.axvline(x=single_PO_bond_wavelength, color='black', linewidth=1.5)
plt.text(single_PO_bond_wavelength, 10 ** (-0.5), "P-O", rotation=90, verticalalignment='center',
         horizontalalignment='right', color='black', fontsize=30)
