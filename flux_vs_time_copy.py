...
organic_mask_end_1 = single_CH_bond_wavelength
...
plt.plot([4.603-x for x in time_list], organic_carbon_flux_organic1_lowerO2, color='black', linewidth=5, linestyle="dotted")
plt.plot([4.603-x for x in time_list], organic_carbon_flux_organic1_averageO2, color='black', linewidth=7)
plt.plot([4.603-x for x in time_list], organic_carbon_flux_organic1_averageO2, color='black', linewidth=10, alpha=0.5)
plt.plot([4.603-x for x in time_list], organic_carbon_flux_organic1_upperO2, color='black', linewidth=5, linestyle="dashed")
...
plt.xlabel("Time, Ga", fontsize=35)
plt.ylabel(f"Organic carbon flux, {unicodeit.replace("g s^{-1} m^{-2}")}", fontsize=28)
plt.yscale('log')
