...
ax1.plot([4.603-x for x in time_list], N2_pressure_lst, color='crimson', linewidth=3)
ax1.plot([4.603-x for x in time_list], N2_pressure_lst, color='crimson', linewidth=8, alpha=0.5)
ax1.plot([4.603-x for x in time_list], CO2_pressure_lst, color='darkgreen', linewidth=3)
...
ax1.plot([4.603-x for x in time_list], O2_pressure_average_lst,color='#28CC7A', linewidth=3)
...
ax1.set_xlabel("Time, Ga", fontsize=45)
ax1.set_ylabel("Pressure, bar", fontsize=45)
ax1.tick_params(axis='both', labelsize=35)
ax2 = ax1.twinx()
ax2.plot([4.603-x for x in time_list], O3_presence_lower_lst, label="O3 P/g (plug)", color='#3333FF', linestyle='dotted', linewidth=3)
ax2.plot([4.603-x for x in time_list], O3_presence_average_lst, label="O3 P/g (plug)", color='#3333FF', linewidth=3)
ax2.plot([4.603-x for x in time_list], O3_presence_average_lst, label="O3 P/g (plug)", color='#3333FF', linewidth=8, alpha=0.5)
ax2.plot([4.603-x for x in time_list], O3_presence_upper_lst, label="O3 P/g (plug)", color='#3333FF', linestyle='dashed', linewidth=3)
ax2.set_ylabel(f"{unicodeit.replace("O_{3} P/g (plug)")}, {unicodeit.replace("kg m^{-2}")}", fontsize=45)
...
plt.axvspan(4.603-0, 4.603-2.203, color='#C26A77', alpha=0.35)
plt.axvspan(4.603-2.203, 4.603-4.003, color='#DCCD7D', alpha=0.35)
plt.axvspan(4.603-4.003, -0.1, color='#94CBEC', alpha=0.35)
