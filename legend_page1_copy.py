...
plt.figure()
plt.plot([], [], label="Before GOE \n(2.6 Ga)", color='#AA4655', linewidth=5)
plt.plot([], [], label="Before NOE, \nafter GOE \n(1.1 Ga)", color='#D5C362', linewidth=5)
plt.plot([], [], label="After NOE \n(Today)", color='#329BDB', linewidth=5)
...
plt.plot([], [], label="UVA", color='#FF6600', linewidth=5, alpha=0.5)
plt.plot([], [], label="UVB", color='#E3006A', linewidth=5, alpha=0.5)
plt.plot([], [], label="UVC", color='#7F66FF', linewidth=5, alpha=0.5)
plt.legend(loc='center', fontsize=25, frameon=False)
plt.axis('off')
...
plt.figure()
plt.plot([], [], label="Total", color='#4D0000', linewidth=5)
plt.plot([], [], label=unicodeit.replace("N_2"), color='crimson', linewidth=5)
plt.plot([], [], label=unicodeit.replace("CO_2"), color='darkgreen', linewidth=5)
plt.plot([], [], label=unicodeit.replace("O_2"), color='#28CC7A', linewidth=5)
plt.plot([], [], label=unicodeit.replace("O_3"), color='#3333FF', linewidth=5)
